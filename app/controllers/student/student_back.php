...
**Purpose: This php script is meant to return a hashed password for a specific student via the user_name. The hashed password is stored in the NJIT's SQL database under the student table. This script will receive two post requests. One that is an action which should be login and the other is the student user_name. The script will then query the database for the student user_name and return the primary key, username and hashed password. 
*/
